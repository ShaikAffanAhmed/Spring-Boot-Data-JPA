...
public class EmployeeController {
     ...
     *  1. SHOW REGISTER PAGE
	     This method is used to display Register page When end-user enters /register with GET type
     */
	    @GetMapping("/register")
	    ...
	    /**
	     * 2. ON CLICK FROM SUBMIT, READ DATA(@MODELATTRIBUTE)
	  ...
	  /*  @GetMapping("/all")
	     ...
	     * on click Delete Hyperlink, a request is made by browser look like /employee/delete?id=someVal.
	     * Read data using annotation @RequestParam and call service to delete from DB.
	     * 
	     * Just redirect to /all with one message (RedirecrAttribute)
